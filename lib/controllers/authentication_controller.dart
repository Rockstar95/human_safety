...
class AuthenticationController {
  ...
  Future<bool> isUserLogin(
      {bool initializeUserid = false, BuildContext? context}) async {
          ...
          case "account-exists-with-different-credential":
            {
              ...
              MyPrint.printOnConsole(
                  "Message:Account Already Exist With Different Method");
              Snakbar.showErrorSnakbar(
                  context: context,
                  msg: "Account Already Exist With Different Method");
            }
            break;
