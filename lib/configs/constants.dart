...
class FirebaseNodes {
  ...
  static MyFirestoreDocumentReference languagewisePostersDocumentReference() =>
      FirestoreController.documentReference(
  ...
  static MyFirestoreCollectionReference get usersCollectionReference =>
      FirestoreController.collectionReference(collectionName: usersCollection);

  static MyFirestoreDocumentReference usersDocumentReference(
          {String? userId}) =>
      FirestoreController.documentReference(
  ...
  static MyFirestoreCollectionReference get questionsCollectionReference =>
      FirestoreController.collectionReference(
          collectionName: questionsCollection);

  static MyFirestoreDocumentReference questionsDocumentReference(
          {String? questionId}) =>
      FirestoreController.documentReference(
        collectionName: questionsCollection,
  ...
  static MyFirestoreCollectionReference get postersCollectionReference =>
      FirestoreController.collectionReference(
          collectionName: postersCollection);

  static MyFirestoreDocumentReference postersDocumentReference(
          {String? posterId}) =>
      FirestoreController.documentReference(
        collectionName: postersCollection,
        documentId: posterId,
