...
import 'package:human_safety/screens/common/components/pin_put.dart';
...
import '../home_screen/sos_numbers_screen.dart';
          ...
          if (isOTPSent) {
            if (!checkEnabledVerifyButton()) {
              ...
              if (verificationId != null) {
                ...
                Snakbar.showErrorSnakbar(
                    context: context, msg: "OTP Expired, Plase Resend");
              }
            }
          } else {
  ...
  Widget getTimer() {
    ...
    return Container(
      ...
      child: CircularCountDownTimer(
        ...
        initialDuration: 0,
        ringColor:
            isTimerOn ? Styles.primaryColor.withAlpha(100) : Colors.white,
