...
class ParsingHelper {
  ...
  static List<T2> parseListMethod<T1, T2>(dynamic value,
      {List<T2> defaultValue = const []}) {
    if (value == null) {
      return defaultValue;
  ...
  static Map<K2, V2> parseMapMethod<K1, V1, K2, V2>(dynamic value,
      {Map<K2, V2> defaultValue = const {}}) {
    if (value == null) {
      return defaultValue;
  ...
  static DateTime? parseDateTimeMethod(dynamic value,
      {DateTime? defaultValue,
      String? dateFormat,
      bool fromMilliseconds = true}) {
    if (value == null) {
      return defaultValue;
  ...
  static Timestamp? parseTimestampMethod(dynamic value,
      {Timestamp? defaultValue, String? dateFormat}) {
    DateTime? dateTime = parseDateTimeMethod(value,
        dateFormat: dateFormat, defaultValue: defaultValue?.toDate());
